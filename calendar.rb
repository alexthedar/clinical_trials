...
require 'google_calendar'
  ...
  cal = Google::Calendar.new(:client_id     => "363758452760-ait4ci85ugbpofsujg5ql3sfuijthifn.apps.googleusercontent.com",
                             :client_secret => "xbpjRuAsTHSQn98HZxkFpft8",
                             :calendar      => "ian@iancmacdonald.com",
